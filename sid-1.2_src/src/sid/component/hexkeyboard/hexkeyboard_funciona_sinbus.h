...
{
public:
	HexKeyboard():row0(this,0),row1(this,1),row2(this,2),row3(this,3),rx(this){
		initkeyboard();		}
	// dummy dtor
	~HexKeyboard() throw ()
	{
...
class Rx_pin: public sid::pin //input rx pin
{
	//When driven, the rx pin will change the keyboard's pressed key
	public:
		Rx_pin() NT;
		Rx_pin (HexKeyboard* k) :keyboard(k){}
		void driven(sid::host_int_4 value) NT {keyboard->press_key(value);}
