...
{
public:
	HexKeyboard():row0(this,0),row1(this,1),row2(this,2),row3(this,3){
		initkeys();		}
	// dummy dtor
	~HexKeyboard() throw ()
	{
...
sid::pin* col1;
sid::pin* col2;
sid::pin* col3; //Receviers of my output pins
...
class Row_pin: public sid::pin //input pins
{
	...
	public:
		...
		void driven(sid::host_int_4 value) NT {keyboard->refresh_output(this);}
...
void refresh_output(Row_pin* row);	
