...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/adrian/_ETSIT-UPM/BECA-SimAntares/sid/src/tk/unix -ltk8.4'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/opt/sid/lib -ltk8.4'
...
# compiled.
TK_SRC_DIR='/home/adrian/_ETSIT-UPM/BECA-SimAntares/sid/src/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/adrian/_ETSIT-UPM/BECA-SimAntares/sid/src/tk/unix -ltkstub8.4'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/opt/sid/lib -ltkstub8.4'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/adrian/_ETSIT-UPM/BECA-SimAntares/sid/src/tk/unix/libtkstub8.4.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/opt/sid/lib/libtkstub8.4.a'
