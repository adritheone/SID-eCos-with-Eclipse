...
#define CYGPKG_HAL_ARM_PID v3_0
#define CYGPKG_HAL_ARM_PID_v3_0
#define CYGNUM_HAL_ARM_PID_VERSION_MAJOR 3
#define CYGNUM_HAL_ARM_PID_VERSION_MINOR 0
#define CYGNUM_HAL_ARM_PID_VERSION_RELEASE -1
#define CYGBLD_HAL_TARGET_H   <pkgconf/hal_arm.h>
#define CYGBLD_HAL_PLATFORM_H <pkgconf/hal_arm_pid.h>
#define CYG_HAL_STARTUP RAM
#define CYG_HAL_STARTUP_RAM
#define CYGHWR_MEMORY_LAYOUT_LDI <pkgconf/mlt_arm_pid_ram.ldi>
#define CYGHWR_MEMORY_LAYOUT_H <pkgconf/mlt_arm_pid_ram.h>
